...
int         Client::get_port(void) const { return _port; }

std::string Client::get_nickname(void) const { return _nickname; }

std::string Client::get_username(void) const { return _username; }

std::string Client::get_realname(void) const { return _realname; }

std::string Client::get_hostname(void) const { return _hostname; }

std::string Client::get_buffer(void) const { return _message_buffer; }

bool        Client::is_disconnected(void) const { return _disconnected; }

bool        Client::is_oper(void) const { return _oper; }

bool        Client::has_nickname(void) const { return !_nickname.empty(); }
